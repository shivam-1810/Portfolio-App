...
class UserProfileFirstTime extends StatefulWidget {
  const UserProfileFirstTime({super.key});
...
class _UserProfileSetupState extends State<UserProfileFirstTime> {
...
Future<void> saveUserProfileDetails({
  ...
  try {
    ...
    await FirebaseFirestore.instance
        ...
        .doc(user.uid)
        .set(userData);
    print('Saving to path: userDetails/${user.uid}');
